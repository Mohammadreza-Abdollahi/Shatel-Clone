...
const LeftOptions = ({
  ...
  return (
    <>
      <section className="top-options sans flex items-center my-10">
        <div
          className="mx-auto flex justify-between items-center"
          style={{ width: 1120 }}
        >
          <section className="w-1/2 px-5">
            <h2 className="sans-bold relative mb-3.5 text-2xl text-slate-800">{title}
              <div className="bottom-line -bottom-2 right-3"></div>
            </h2>
            <p className="text-slate-800 text-sm text-justify">{par}</p>
